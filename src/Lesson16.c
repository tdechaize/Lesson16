 ...
 ***************************************************************
 *  $Author : Christopher Aliotta & Jeff Molofee 2000
 *  $Name :  $
 ***************************************************************
 *
...
*
* \file            Lesson16.c
* \author          Christopher Aliotta & Jeff Molofee 2000 ( NeHe ) originely, Modified for LCCWin32 compiler by Robert Wishlaw 2002/11/23
* \author          After adapted by Thierry Dechaize to verify paradigm : one source for multiple C Compilers
* \version         2.0.1.0
* \date            14 fevrier 2022
* \brief           Ouvre une simple fenêtre Windows et dessine un cube avec OpenGL dans une ambiance de brouillard.
